...
`.github/scripts/skills.py` holds this file, and every skill it indexes, to a
length: a section that outgrows it is carrying something a skill, or a
`references/` file beside one, should have.
