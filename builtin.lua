...
---
--- This factory returns definitions; main.lua registers every one through the
--- same registry as user columns. Requiring this module has no side effects.
---
...
--- `no built-in names a colour` walks the catalogue and refuses a `style` on
